		...
		<footer>
			...
			<ul className="footer-list">
				<li className="footer-item">
					<p>
						{"   "}
						<img id="f" src={logo} alt="" /> {"   "}E-ggle is perhaps the
						biggest name in online courses and education. It has a global roster
						of universities and partners to offer more than 10 specialized
						courses.
					</p>
				</li>
				<li className="footer-item">
